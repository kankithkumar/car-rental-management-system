...
CREATE TABLE `booking` (
  ...
  `BOOK_STATUS` ENUM('APPROVE', 'RETURNED', 'OVERDUE') NOT NULL DEFAULT 'APPROVE'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(66, 2, 'swasthik@gmail.com', 'bangalore', '2022-03-22', 5, 6363549133, 'moodabidri', '2022-04-09', 35000, 'APPROVE'),
